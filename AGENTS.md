...
Full documentation: [`docs/index.md`](docs/index.md) (deployed at [/guide/](https://fytc.ac/everyday-arXiv/guide/)).

> 每日 arXiv 论文获取与 LLM 智能筛选框架。完整文档：[`docs/index.md`](docs/index.md)（部署在 [/guide/](https://fytc.ac/everyday-arXiv/guide/)）。
